...
const _config = {
  ...
  apiUrl: _removeSlash(process.env.KOBITON_API_URL || 'https://portal-api.kobiton.com/') + '/',
  ...
  emailOrUsername: process.env.USERNAME_1 || 'tester',
  password: process.env.PASSWORD_1 || '123456',
