...
public class iOSAppTest {
    ...
    Expected: It should show at least 6 results.
        ...
        Assert.assertTrue(firstResult.size() >= 33, "The expected results are greater or equal to 33 results.");
        Assert.assertTrue(secondResult.size() >= 6, "The expected results are greater or equal to 6 results.");
    }
