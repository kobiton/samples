...
class script1449298190753 extends com.kms.katalon.core.export.ExportTestCaseScript { 

    static void main(java.lang.String[] args) {
        super.main(this, 'Test Cases/Commons/Common_CleanTrash', '/Users/khanhdo/Desktop/KryptonExport/Krypton_20151205-134950', 'Firefox', null, 30)
    }
    ...
    def run() {
        ...
        'Click on Left Bar Menu'
        WebUiBuiltInKeywords.click(ObjectRepository.findTestObject('Object Repository/MainPage/btn_Trash'), FailureHandling.STOP_ON_FAILURE)
        'delay'
        WebUiBuiltInKeywords.delay(GlobalVariable.WAIT, FailureHandling.STOP_ON_FAILURE)
        getItemsStatus = WebUiBuiltInKeywords.waitForElementPresent(ObjectRepository.findTestObject('Object Repository/TrashFolder/chkbox_listitem'), GlobalVariable.WAIT, FailureHandling.OPTIONAL)
        if (getItemsStatus == true) {
            CustomKeywords.'com.kms.krypton.CustomKeywords.clickAllItems'(ObjectRepository.findTestObject('Object Repository/TrashFolder/chkbox_listitem'), FailureHandling.STOP_ON_FAILURE)
            'delay'
            WebUiBuiltInKeywords.delay(GlobalVariable.WAIT, FailureHandling.STOP_ON_FAILURE)
            'Click on Delete Forever'
            CustomKeywords.'com.kms.krypton.CustomKeywords.clickFirstItem'(ObjectRepository.findTestObject('Object Repository/TrashFolder/btn_DeleteForever'), FailureHandling.STOP_ON_FAILURE)
            'delay'
            WebUiBuiltInKeywords.delay(GlobalVariable.WAIT, FailureHandling.STOP_ON_FAILURE)
        }
