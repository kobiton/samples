...
describe "Android Web Test" do
    ...
    before(:all) do 
        ...
        @driver = Selenium::WebDriver.for(:remote, :url => caps.desired_caps_android_web[:url], :desired_capabilities => caps.desired_caps_android_web[:caps])
    ...
    it "login successfully", :retry => 10 do
